...
The purpose of this is to learn about Web Applications and Development with a focus on security.

# Accomplishments
  Implemented session based authentication for users
  Implemented application layer encryption modeled off the TLS protocol
...
For one reason or another some issues were not immediately addressed when identified.
  ...
  The frontend has not been protected against common website attacks, SQL Injection, XXS, etc, this is on the backburner for now.
