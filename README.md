...
The script was a game where the user controls a jet (looks more like a rocket ship) in outer space (definitely a rocket ship) and needs to dodge asteroids (the binary) for as long as they can.
